...
I borrowed Professor Matt Might's [illustrated guide](http://matt.might.net/articles/phd-school-in-pictures/) to a Phd and added in some of the early struggles I had, how I got through them and where I am now.  I plan to post a cleaned up version of the talk here, because as I finally delivered it, it became more clear.   
...
Even the tech went smoothly, I used an [app on my phone](http://www.unifiedremote.com) as a presentation remote over bluetooth so that I could walk around and not be trapped behind the podium.  
